...
export function renderCell(
	...
	// Diagonal borders (<a:lnTlToBr>, <a:lnBlToTr>) — TODO: render via an
	// SVG overlay positioned over the cell. For now we just note their
	// presence; a future patch can add the overlay.
	// See TableCellBorders.tlbr / .blTr.
